...
module.exports = function(router){
    ...
    router.post('/users', function(req,res){
        ...
        if(req.body.username == null || req.body.password == null || req.body.email == null || req.body.dateofbirth == null || req.body.username == '' || req.body.password == '' || req.body.email == '' || req.body.dateofbirth == '' ){
            res.json({success:false,msg:'Ensure username, email, password and Date of Birth were provided'});
        }
        else{
